...
#save(origmodeldata,paramsets,paramsetnames,dependent,file=paste("./data/modeldata/RForigmodeldatawithgeo_",dependent,".RData",sep="")) }
...
#for (p in paramsets){
  ...
  mydir=paste("./data/RFwithgeo_fw_5fold_10p_",dependent,"_",predset_name,sep="")
  dir.create(mydir)
  #############################################################################################################################
  #############################################################################################################################
  k=5
