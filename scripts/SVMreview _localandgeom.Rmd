...
for(i in 1:length(dependentlist)){
  ...
  preds <- evaluateforwardCV_anyerror(mypath=paste("../data/FSCV/SVM_localandgeom/SVMwithgeoandgeom_fw_5fold_10p_",dep,"_NA",sep=""),kk=1:5,endround = 10,error = "cverror",geheim = "geheimerprederror",yrange=c(0,1))
