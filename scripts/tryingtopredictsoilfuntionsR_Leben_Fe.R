...
predictors <- c("geom_10m_fl10_L70")
oldprednames<- c("geom_10m_fl10_L70")
dependent=dependentlist[2]
### get raster names##########################################################################
...
############################################################################################################################################################
####SET PREDICTORS AND DEPENDENT#############################################################
predictors <- c("geom_10m_fl10_L70","CrossSectionalCurvature_hr")
oldprednames<- c("geom_10m_fl10_L70","CrossSectionalCurvature_hr")
dependent=dependentlist[2]
### get raster names##########################################################################
ST = "SUEDTIROL_DTM_NEU"                                                                     #
ST_mapsets= list.dirs(paste(gisDbase,"/",ST,sep=""),recursive = F,full.names = F)            #
...
############################################################################################################################################################
####SET PREDICTORS AND DEPENDENT#############################################################
predictors <- c("geom_10m_fl10_L70","Longitudinal_Curvature_hr")
oldprednames<- c("geom_10m_fl10_L70","Longitudinal_Curvature_hr")
dependent=dependentlist[2]
### get raster names##########################################################################
ST = "SUEDTIROL_DTM_NEU"                                                                     #
ST_mapsets= list.dirs(paste(gisDbase,"/",ST,sep=""),recursive = F,full.names = F)            #
